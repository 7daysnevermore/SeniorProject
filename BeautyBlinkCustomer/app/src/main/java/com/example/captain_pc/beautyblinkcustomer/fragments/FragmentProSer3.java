...
public class FragmentProSer3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_proser3,container,false);
    ...
    public static FragmentProSer3 newInstance(){
        FragmentProSer3 fragment = new FragmentProSer3();
