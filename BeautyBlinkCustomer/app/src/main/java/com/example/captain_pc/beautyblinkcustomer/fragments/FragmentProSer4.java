...
public class FragmentProSer4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_proser4,container,false);
    ...
    private void initInstance(View rootView) {
        ...
        Query dataQuery1 = databaseRef.orderByChild("service").equalTo("S04");
    ...
    public static FragmentProSer4 newInstance(){
        FragmentProSer4 fragment = new FragmentProSer4();
